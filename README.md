...
- Built an LLM benchmarking framework across **6 candidate language models,** generating **42,000 reconstructed reports** via provider APIs and evaluating using text and semantic similarity metrics, clincal scoring, and operational performance metrics
- Integrated business insights into production system workflows, converting anaylsis into actionable guidance
