...
Developed pipelines with core emphasis on clinical transparency and model interpretability, using PyTorch, Scikit-Learn, Hugging Face, and versioned Google Cloud Run deployment.

Currently contributing to R&D workflows at RadNomics using GKE-based cloud infrastructure for production-scale radiology RAG system.
...
- Currently executing evaluation pipeline on 9 candidate LLMs across 7 metric types to optimise API call workflows
...
- ***MSc, Computer Science with Artificial Intelligence*** @ City St George’s, University of London
  - **Relevant Modules:** _Machine Learning, Artificial Intelligence, Cloud Computing, Software Engineering, Databases_
