...
Built and deployed pipelines with PyTorch, LightGBM, and Hugging Face Transformers  

Experience with production-oriented cloud ML workflows (GKE, Kubernetes) at RadNomics  
